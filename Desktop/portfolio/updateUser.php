...
require_once("classes/User.php");
  ...
  $row = $user->getSpecificUser($loginid);
...
<body id="page-top" data-spy="scroll" data-target=".navbar-custom">
  ...
  <section id="contact" class="home-section nopadd-bot color-dark bg-white text-center">
    ...
    Displays name<input type="text" name="name" Value="<?php echo $row['name'];?>"><br>
    Address<input type="text" name="pass" Value="<?php echo $row['address'];?>"><br>
    Number<input type="text" name="num" Value="<?php echo $row['number'];?>"><br>
    Password<input type="text" name="address" Value="<?php echo $row['password'];?>"><br>
    <input type="hidden" name="loginid" value="<?php echo $row['loginid'];?>"><br>
